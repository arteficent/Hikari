...
namespace SyncServer.Controllers
{
    ...
    public class UploadController : ControllerBase
    {
        ...
        public UploadController(ILogger<UploadController> logger, IOptions<SyncServer.Abstraction.AmazonWebServicesConstants> awsConstants, IMusicRepository musicRepository, IAmazonS3 client)
        {
            _awsConstants = awsConstants?.Value ?? new SyncServer.Abstraction.AmazonWebServicesConstants();
            _logger = logger;
